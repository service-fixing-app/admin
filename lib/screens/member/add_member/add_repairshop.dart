...
import 'package:admin/controllers/member/add_repairshopController.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
import 'package:get/get.dart';
import 'package:image_picker/image_picker.dart';

class AddRepairshop extends StatefulWidget {
  const AddRepairshop({Key? key}) : super(key: key);

  @override
  State<AddRepairshop> createState() => _AddRepairshopState();
}

class _AddRepairshopState extends State<AddRepairshop> {
...
// selected province and district
  ...
  final RepairshopRegisterController _repairshopRegisterController =
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: () async {
                        ...
                        // print(
                        //     'village: ${selectTypeService ?? 'Not selected'}');
                        // print('village: ${latitudeController.text}');
                        // print('village: ${longitudeController.text}');

                        await _repairshopRegisterController
                            .repairshopRegistrationData(repairshop);
                      },
                      ...
                      child: Obx(() {
                        return _repairshopRegisterController.isLoading.value
                            ? const Row(
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: [
