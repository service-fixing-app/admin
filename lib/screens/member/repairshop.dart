            ...
            Builder(
              builder: (context) => Tooltip(
                ...
                child: IconButton(
                  ...
                  onPressed: () {
                    _showBlockConfirmationDialog(context, repairshop['id']);
                  },
                ),
              ),
            ),
    ...
    builder: (BuildContext context) {
      return AlertDialog(
        ...
        content: const SingleChildScrollView(
          child: ListBody(
            children: <Widget>[
              Text('ທ່ານແນ່ໃຈບໍ່ວ່າຕ້ອງການ Block ຮ້ານສ້ອມແປງນີ້?'),
            ],
          ),
        ),
        actions: <Widget>[
          ...
          TextButton(
            ...
            onPressed: () async {
              Navigator.of(context).pop();
              await deleteRepairshopController.UpdatePermission(repairshopId);
            },
          ),
        ],
      );
