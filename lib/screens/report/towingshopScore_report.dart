...
class TowingshopScoreReport extends StatefulWidget {
  const TowingshopScoreReport({Key? key}) : super(key: key);

  @override
  State<TowingshopScoreReport> createState() => _TowingshopScoreReportState();
}

class _TowingshopScoreReportState extends State<TowingshopScoreReport> {
  ...
  final GetScoreTowingshopController _getScoreTwoingshopController =
      Get.put(GetScoreTowingshopController());
  ...
  void initState() {
    ...
    _getScoreTwoingshopController.fetchScoreTowingshopData();
    _startDate = null;
    _endDate = null;
  ...
  List<Map<String, dynamic>> getFilteredRows() {
    if (_startDate == null && _endDate == null) {
      return _getScoreTwoingshopController.towingScoreData;
    } else {
      return _getScoreTwoingshopController.towingScoreData.where((row) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Obx(() {
        if (_getScoreTwoingshopController.towingScoreData.isEmpty) {
