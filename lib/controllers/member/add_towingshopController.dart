...
class TowingshopRegisterController extends GetxController {
  var isLoading = false.obs;
  var isSuccess = false.obs;

  Future<void> towingshopRegistrationData(Towingshop shop) async {
    try {
      ...
      if (imageUrl == null) {
        var response = await http.post(
          Uri.parse('http://localhost:5000/api/towingtruck/addTowingtruck'),
          body: {
